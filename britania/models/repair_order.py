...
class RepairFee(models.Model):
    ...
    def _compute_costo_repair_fee(self):
        # print("---------------------------------------------")
        # print("test de que llego al REPAIR FEE ")
        # print("---------------------------------------------")
        for line in self:
            ...
            print(line.product_id.product_tmpl_id.standard_price,' Producto ', line.product_id.name," Costo Total=", line.costo)
