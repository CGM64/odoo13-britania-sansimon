...
class SaleAdvancePaymentInv(models.TransientModel):
    ...
    def create_invoices(self):
        ...
        for sale_order in sale_orders:
            print("sale_order.user_id.id: ",sale_order.user_id.id)
            print("self.env.user.id: ",self.env.user.id)
            print("porcentaje_maximo: ",sale_order.team_id.porcentaje_maximo)
            print("porcentaje_maximo_lider: ",sale_order.team_id.porcentaje_maximo_lider)
